        ...
        <div className="row">
            <div className="col-lg-5">
                <div className="section-header">
                    ...
                    <p className=" wow fadeInLeft" data-wow-delay=".4s">Empowering people in new a digital journey
                ...
                <div className="testimonials-widget wow fadeInRight" data-wow-delay=".5s">
                    <div className="owl-carousel testimonial-carousel">
                        <div className="testimonial-item">
                            ...
                            <p className="quote">“Taylor is a professional Designer he really helps my business by
